...
// Removed unused imports - we're uploading directly without compression
...
export default function NotreComite() {
    ...
    const uploadProfilePicture = async () => {
        ...
        // Upload file directly without any compression or size limits
        // FormData can handle very large files without issues
